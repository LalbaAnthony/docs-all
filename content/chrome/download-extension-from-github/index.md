...
6. Choose a destination folder you'll remember (e.g., `Documents/my-extension`) and click **Extract**.
   ...
   <img src="https://raw.githubusercontent.com/LalbaAnthony/docs-all/main/content/chrome/download-extension-from-github/assets/download-screenshot.png" alt="GitHub Download ZIP" width="400"/>
